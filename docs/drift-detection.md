...
**See also:** [Characterization Test](characterization-test.md) · [Fitness Functions](fitness-functions.md) · [Static Analysis](static-analysis.md) · [Variant Analysis](variant-analysis.md)
{ .see-also }
