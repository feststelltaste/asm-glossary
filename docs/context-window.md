...
image: assets/images/en/context-window.png
---

# Context Window

![context-window](assets/images/en/context-window.png)
...
**See also:** [RAG](rag.md) · [Code Knowledge Graph](code-knowledge-graph.md) · [Agent Memory](agent-memory.md) · [Prompt Engineering](prompt-engineering.md) · [Scratchbook](scratchbook.md)
{ .see-also }
