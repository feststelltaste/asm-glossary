...
![structured-output](assets/images/en/structured-output.png)
...
**See also:** [Tool Use](tool-use.md) · [Orchestration](orchestration.md) · [Agent Teams](agent-teams.md) · [Handoff Protocol](handoff-protocol.md)
{ .see-also }
