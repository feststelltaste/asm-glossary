...
![orchestration](assets/images/en/orchestration.png)
...
**See also:** [Agent Teams](agent-teams.md) · [Multi-Step Planning](multi-step-planning.md) · [Structured Output](structured-output.md) · [Hub-and-Spoke Orchestration](hub-and-spoke-orchestration.md) · [Handoff Protocol](handoff-protocol.md)
{ .see-also }
