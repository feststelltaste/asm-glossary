...
# :fontawesome-solid-shield-halved: Entwicklung & Kontrolle
...
- [Konfidenzbasierte Eskalation](../konfidenzbasierte-eskalation.md)
- [Leitplanken](../leitplanken.md)
- [Migrationsdashboard](../migrationsdashboard.md)
