...
translation_en: language-server-protocol
translation_en_title: Language Server Protocol (LSP)
---

# Language Server Protocol (LSP)

![language-server-protocol](assets/images/language-server-protocol.png)
...
**Siehe auch:** [Code-Verständnis](code-verstaendnis.md) · [Agentische Suche](agentische-suche.md) · [Statische Analyse](statische-analyse.md)
{ .see-also }
