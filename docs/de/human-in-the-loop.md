...
![human-in-the-loop](assets/images/human-in-the-loop.png)
...
**Siehe auch:** [Leitplanken](leitplanken.md) · [Intent Engineering](intent-engineering.md) · [Mehrschrittplanung](mehrschrittplanung.md) · [Konfidenzbasierte Eskalation](konfidenzbasierte-eskalation.md) · [Stratifizierte Review-Stichprobe](stratifizierte-review-stichprobe.md) · [Zonen](zonen.md)
{ .see-also }
