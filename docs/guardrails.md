...
![guardrails](assets/images/en/guardrails.png)
...
**See also:** [Harness Engineering](harness-engineering.md) · [Human-in-the-Loop](human-in-the-loop.md) · [Hooks](hooks.md) · [Confidence-Based Escalation](confidence-based-escalation.md) · [Sandboxing](sandboxing.md) · [Zones](zones.md)
{ .see-also }
