...
# :fontawesome-solid-shield-halved: Engineering & Control
...
- [Coverage Gap Annotation](../coverage-gap-annotation.md)
...
- [Stratified Review Sampling](../stratified-review-sampling.md)
